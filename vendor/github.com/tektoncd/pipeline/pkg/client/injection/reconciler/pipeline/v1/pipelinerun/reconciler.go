...
// handleSSAAdmissionErrorForMissingObject checks if the error is a result of trying to create
...
func (r *reconcilerImpl) handleSSAAdmissionErrorForMissingObject(ctx context.Context, err error, resource *v1.PipelineRun) error {
...
func (r *reconcilerImpl) addFinalizerSSA(ctx context.Context, resource *v1.PipelineRun) (*v1.PipelineRun, error) {
	...
	if err != nil {
		...
		if convertedErr := r.handleSSAAdmissionErrorForMissingObject(ctx, err, resource); convertedErr != err {
			return resource, convertedErr
		}
